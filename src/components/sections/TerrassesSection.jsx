...
import { FaClone, FaRuler, FaGem, FaLeaf, FaBroom } from "react-icons/fa";
import InfoModal from "@/components/InfoModal";
import { useI18n } from "@/i18n/I18nProvider";

export default function TerrassesSection() {
  const { t } = useI18n();
    ...
    <div ref={sectionRef} className="mx-auto w-full max-w-6xl px-4 sm:px-6">
      ...
      <div className="grid gap-2 sm:gap-3 md:gap-4 grid-cols-1 md:grid-cols-2">
        ...
        <div
          ...
          onClick={() =>
            handleOpenModal(
              t("terrasses.cards.conception.title"),
              explications.conception,
        ...
        >
          ...
          <p className="text-gray-600 text-center text-xs sm:text-sm">
            {t("terrasses.cards.conception.subtitle")}
          </p>
        </div>
        ...
        <div
          ...
          onClick={() =>
            handleOpenModal(
              t("terrasses.cards.materiaux.title"),
              explications.materiaux,
        ...
        >
          ...
          <p className="text-gray-600 text-center text-xs sm:text-sm">
            {t("terrasses.cards.materiaux.subtitle")}
          </p>
        </div>
        ...
        <div
          ...
          onClick={() =>
            handleOpenModal(
              t("terrasses.cards.amenagement.title"),
              explications.amenagement,
        ...
        >
          ...
          <p className="text-gray-600 text-center text-xs sm:text-sm">
            {t("terrasses.cards.amenagement.subtitle")}
          </p>
        </div>
        ...
        <div
          ...
          onClick={() =>
            handleOpenModal(
              t("terrasses.cards.entretien.title"),
              explications.entretien,
              <FaBroom className="text-amber-500" />
            )
          }
          title={tt("ui.hint.clickCard", "Cliquer pour voir le détail")}
        >
          ...
          <p className="text-gray-600 text-center text-xs sm:text-sm">
            {t("terrasses.cards.entretien.subtitle")}
          </p>
        </div>
      </div>

      {/* Message discret après inactivité */}
      {showIdleInfo && (
